...
class chesscog(commands.Cog):
	...
	@commands.command(brief='Start a game with tagged player', description="Takes: member, side (default, author = white), vairation (960 for random). Tag the bot to play against stockfish (use set_tt to change difficulty).")
	...
	@commands.command(brief='Make a move (standard notation)', description="fyi 0-0 kingside castle, 0-0-0 queenside")
	...
	@commands.command(brief='Print PGN of game')
	async def log(ctx):
		if len(game) == 0:
	...
	@commands.command(brief='End game')
	...
	@commands.command(brief='Show current board state', description="Add anything after cheat so only person who asked recieves board (can be configured to use ascii or send png of board)")
	...
	@commands.command(brief='Show taken pieces')
	...
	@commands.command(brief='Show who is winning', description="Takes depth, adding \"score\" will show you the score value")
	...
	@commands.command(brief="Render game as gif", description="Render game as gif with annoations")
	...
	@commands.command(brief='Set stockfish think time', desciption="Increasing will make game harder")
	...
	@commands.command(brief='Set random opening', description='Set random opening')
